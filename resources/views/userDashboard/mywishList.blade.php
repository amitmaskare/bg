                                            ...
                                            <div class="wallet-table mt-0">
                                                <div class="table-responsive">
                                                    <table class="table cart-table order-table">
                                                        ...
                                                        <tbody>
                                                        @if($data['WishListData'] && count($data['WishListData']) > 0)
                                                            @foreach($data['WishListData'] as $index => $item)
                                                            ...
                                                            <tr>
                                                                <td><img src="{{asset('uploads/product/'.$products->main_image)}}" style="width:50px" alt=""
                                                                   > <span class="fw-bolder me-2"> {{$products->product_name}}</span></td>
                                                                
                                                                 <td><span class="fw-bolder">{{$products->price}}</span></td>
