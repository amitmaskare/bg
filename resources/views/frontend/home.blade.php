...
@section('content')
 ...
 <section class="p-0 small-slider">
        <a href="{{route('shop')}}">
            <img src="{{asset('assets/images/vegetables-4/full-banner/1.png')}}" alt="" class="img-fluid blur-up lazyload">
        </a>
    </section>
    <!-- Home slider end -->
                    ...
                    <a href="category-page(vegetables).html">
                        <div class="category-boxes">
                            <div class="img-sec">
                                ...
                                <img src="{{asset('uploads/category/'.$item['image'])}}" class="img-fluid" alt="">
                                @else
                                <img src="{{asset('assets/images/product-details/product/1.jpg')}}" class="img-fluid" alt="">
                                @endif
                            </div>
            ...
            <div class="row g-4">
                <div class="col-6 col-lg-4">
                    <a href="{{route('shop')}}">
                        <div class="collection-banner p-right text-end">
                            <div class="img-part">
                                <img src="{{asset('assets/images/vegetables-4/banner/1.png')}}"
                ...
                <div class="col-6 col-lg-4">
                    <a href="{{route('shop')}}">
                        <div class="collection-banner p-right text-end">
                            <div class="img-part">
                                <img src="{{asset('assets/images/vegetables-4/banner/2.png')}}"
                                    class="img-fluid blur-up lazyload w-100" alt="">
                            </div>
                ...
                <div class="col-6 col-lg-4">
                    <a href="{{route('shop')}}">
                        <div class="collection-banner p-right text-end">
                            <div class="img-part">
                                <img src="{{asset('assets/images/vegetables-4/banner/3.png')}}"
                                    class="img-fluid blur-up lazyload w-100" alt="">
                            </div>
    ...
    <section class="bag-product ratio_square">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <div class="title8">
                        <h2>Do you sell below items</h2>
                        <p>We have buyers,Click below and send your price</p>
                ...
                <div class="col-12">
                    <div class="product-5 product-m no-arrow">
                        @if($data['listingDesc'])
                        @foreach($data['listingDesc'] as $item)
                                                    ...
                                                    <div class="basic-product theme-product-1">
                                                        <div class="overflow-hidden">
                                                            <div class="img-wrapper">
                                                               ...
                                                               @php
                                                                    $avg = number_format($item->avg_rating ?? 0, 1); // shows 3.5
                                                                @endphp
                                                                        ...
                                                                        <a class="product-title"
                                                                         ...
                                                                         <div class="color-panel">
                                                                            <!-- <ul>
                                                                                ...
                                                                                <li
                                                                                    sty le="background-color: burlywood;">
                                                                                </li>
                                                                                <li
                                                            ...
                                                            <!-- <div class="product-action">
                                                                @if (Auth::check())
                                                                    <a  href="{{route('shopdetail',['id' => $item['id']])}}" title="Add to bid" style="font-size:inherit;background-color:#f8f8f8;font-weight:200;padding:8px 14px;gap:5px;color:#222" ><i
                                                                    class="fa fa-gavel"></i>Bid price</a>
                                                                    ...
                                                                    @else
                                                                    <a href="{{route('authlogin')}}" title="Add to bid" style="font-size:inherit;background-color:#f8f8f8;font-weight:200;padding:8px 14px;gap:5px;color:#222"><i class="fa fa-gavel"></i>Bid price</a>
                                                                    <button class="add-to-cart-btn" 
                                                                        data-product-id="{{ $item['id'] }}" 
                                                                        data-price="{{ $item['price'] }}">
                                                                    <i class="ri-shopping-cart-line"></i> Add to cart
    ...
    <section class="bag-product ratio_square">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <div class="title8">
                        <h2>Buy from below items</h2>
                        <p>For the price you like</p>
                    </div>
                </div>
                <div class="col-12">
                    <div class="product-5 product-m no-arrow">
                    @if($data['buy_now'])
                        @foreach($data['buy_now'] as $item)
                        <div class="col-xl-4 col-6 col-grid-box">
                                                    <div class="basic-product theme-product-1">
                                                        <div class="overflow-hidden">
                                                            <div class="img-wrapper">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-12">
                    <div class="product-5 product-m no-arrow">
                    @if($data['mostSearch'])
                        @foreach($data['mostSearch'] as $item)
                        <div class="col-xl-4 col-6 col-grid-box">
                                                    <div class="basic-product theme-product-1">
                                                        <div class="overflow-hidden">
                                                            <div class="img-wrapper">
            ...
            <div class="row">
                ...
                <div class="col-12">
                    ...
                    @if($data['featuredProduct'])
                        @foreach($data['featuredProduct'] as $item)
                        <div class="col-xl-4 col-6 col-grid-box">
                                                    <div class="basic-product theme-product-1">
                                                        <div class="overflow-hidden">
                                                            <div class="img-wrapper">
                ...
                <div class="row partition2">
                    <div class="col-md-4">
                        <a href="{{route('shop')}}">
                            <div class="collection-banner p-right text-center">
                                <div class="img-part">
                                    <img src="{{asset('assets/images/vegetables-4/banner/4.png')}}"
                    ...
                    <div class="col-md-4">
                        <a href="{{route('shop')}}">
                            <div class="collection-banner p-right text-center">
                                <div class="img-part">
                                    <img src="{{asset('assets/images/vegetables-4/banner/5.png')}}"
                                        class="img-fluid blur-up lazyload" alt="">
                                </div>
                            </div>
                        </a>
                    ...
                    <div class="col-md-4">
                        <a href="{{route('shop')}}">
                            <div class="collection-banner p-right text-center">
                                <div class="img-part">
                                    <img src="{{asset('assets/images/vegetables-4/banner/6.png')}}"
                                        class="img-fluid blur-up lazyload" alt="">
                                </div>
                            </div>
                        </a>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-12">
                    <div class="product-5 product-m no-arrow">
                    @if($data['lowestPrice'])
                        @foreach($data['lowestPrice'] as $item)
                        <div class="col-xl-4 col-6 col-grid-box">
                                                    <div class="basic-product theme-product-1">
                                                        <div class="overflow-hidden">
                                                            <div class="img-wrapper">
    ...
    <section class="bag-product ratio_square">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <div class="title8">
                        <h2>Highest Price Vegetables & Fruites</h2>
                ...
                <div class="col-12">
                   ...
                   @if($data['highestPrice'])
                        @foreach($data['highestPrice'] as $item)
                        <div class="col-xl-4 col-6 col-grid-box">
                                                    <div class="basic-product theme-product-1">
                                                        <div class="overflow-hidden">
                                                            <div class="img-wrapper">
                    ...
                    <div class="slide-4 no-arrow">
                        <div>
                            <a href="blog-details.html">
                                <div class="basic-effect">
                                    <div>
                                        <img src="{{asset('assets/images/vegetables-4/blog/1.png')}}"
                        ...
                        <div>
                            <a href="blog-details.html">
                                <div class="basic-effect">
                                    <div>
                                        <img src="{{asset('assets/images/vegetables-4/blog/2.png')}}"
                                            class="img-fluid blur-up lazyload bg-img" alt="">
                                        <span></span>
                                    </div>
                                </div>
                        ...
                        <div>
                            <a href="blog-details.html">
                                <div class="basic-effect">
                                    <div>
                                        <img src="{{asset('assets/images/vegetables-4/blog/3.png')}}"
                                            class="img-fluid blur-up lazyload bg-img" alt="">
                                        <span></span>
                                    </div>
                                </div>
...
function addwishList(productId) {
    ...
    .then(data => {
        if (data.success) {
            ...
            alert(data.message || 'Already in wishlist or not logged in');
        }
    })
    .catch(error => {
