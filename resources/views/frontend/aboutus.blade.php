...
@section('content')
 <div class="breadcrumb-section">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="banner-section">
                        @if($aboutus->image && file_exists(public_path('uploads/cms/'.$aboutus->image)))
                                <img src="{{ asset('uploads/cms/'.$aboutus->image) }}" class="img-fluid blur-up lazyload" alt="" style="width: 100%; height: 400px; object-fit: cover;">
                            @else
                                <img src="{{ asset('assets/images/avtar.jpg') }}"  class="img-fluid blur-up lazyload" alt="" >
                            @endif
    ...
    <section id="team" class="team section-b-space slick-default-margin">
        <div class="container">
            <div class="title1">
                <h2 class="title-inner1 border-0">Multikart Team Member</h2>
            </div>
