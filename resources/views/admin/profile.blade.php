                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="profile-details text-center">
                                        <img src="{{asset('admin/images/dashboard/designer.jpg')}}" alt=""
                                            class="img-fluid img-90  blur-up lazyloaded">
                                        <h5 class="f-w-600 mb-0">{{$admindata->name}}</h5>
                                            ...
                                            <div class="table-responsive profile-table">
                                                <table class="table table-borderless">
                                                    <tbody>
                                                        <tr>
                                                            <td>First Name:</td>
                                                            <td><input type="text" class="form-control" name="name" value="{{$admindata->name}}"></td>
                                                        </tr>
                                                      
                                                        <tr>
                                                            <td>Email:</td>
                                                            <td><input type="text" class="form-control" name="email" value="{{$admindata->email}}"></td>
                                                        </tr>
                                                       
                                                        <tr>
                                                            <td>Location:</td>
                                                            <td><input type="text" name="country" class="form-control" value="{{$admindata->country}}"></td>
                                                        </tr>
                                                        <tr>
                                                            <td></td>
