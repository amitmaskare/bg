                                ...
                                <div class="warning-box card-body">
                                    <div class="media static-top-widget align-items-center">
                                        ...
                                        <div class="media-body media-doller">
                                            ...
                                            <h3 class="mb-0">$ <span class="counter">  <h2 class="text-primary">{{ $totalOrderAmountLastMonth }}</h2></span><small> This
                                                    Month</small>
                                            </h3>
                                        </div>
                                    </div>
                                ...
                                <div class="secondary-box card-body">
                                    <div class="media static-top-widget align-items-center">
                                        ...
                                        <div class="media-body media-doller">
                                            ...
                                            <h3 class="mb-0">$ <span class="counter">{{ $lastMonthProductCount }}</span><small> This
                                                    Month</small>
                                            </h3>
                                        </div>
                                    </div>
                                ...
                                <div class="primary-box card-body">
                                    <div class="media static-top-widget align-items-center">
                                        ...
                                        <div class="media-body media-doller"><span class="m-0">Messages</span>
                                            <h3 class="mb-0">$ <span class="counter">{{ $lastMonthMessageCount }}</span><small> This
                                                    Month</small></h3>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="user-status table-responsive latest-order-table">
                                        <table class="table table-bordernone">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td>{{ $order->orderId }}</td>
                                                    <td class="digits">{{ $order->currency }}{{ $order->total_amount }}</td>
                                                    <td class="">  <label class="btn btn-primary">{{ $order->payment_method }}</label></td>
                                                    <td class="digits"><label class="btn btn-info">{{ $order->status }}</label></td>
                                                </tr>
                                                     @empty
                                                        <tr>
                                        ...
                                        <a href="{{route('order')}}" class="btn btn-primary mt-4">View All Orders</a>
                                    </div>
                                    <div class="code-box-copy">
                                        <button class="code-box-copy__btn btn-clipboard"
